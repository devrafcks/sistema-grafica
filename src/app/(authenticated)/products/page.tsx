    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      {lowStockItems.length > 0 && (
        <Alert variant="warning" className="border-amber-200 bg-amber-50/50">
          ...
          <AlertTitle className="text-amber-800">Atenção: Nível de Estoque Baixo</AlertTitle>
          <AlertDescription className="text-amber-700">
            Existem {lowStockItems.length} itens com estoque igual ou inferior a 10 unidades. 
