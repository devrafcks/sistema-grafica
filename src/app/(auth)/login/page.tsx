...
import { Printer, CheckCircle2, Package } from "lucide-react" // Added Package import
...
export default function LoginPage() {
  return (
    <div className="flex min-h-screen bg-background text-foreground h-full w-full">
      ...
      <div className="hidden lg:flex lg:flex-1 relative bg-brand-primary overflow-hidden"> {/* Changed bg-blue-600 to bg-brand-primary */}
        <div 
          className="absolute inset-0 z-0" 
          style={{
            backgroundImage: 'radial-gradient(var(--color-brand-primary-light-alpha) 2px, transparent 2px)', // Changed rgba(255, 255, 255, 0.15) to var(--color-brand-primary-light-alpha)
            backgroundSize: '30px 30px'
          }}
        />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-brand-primary/30 blur-[120px] pointer-events-none z-0"></div> {/* Changed bg-blue-400/30 to bg-brand-primary/30 */}
            ...
            <div className="space-y-8 text-white">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-brand-primary-light text-sm mt-1">Registre cópias, impressões e encadernações em segundos.</p> {/* Changed text-blue-100/90 to text-brand-primary-light */}
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-brand-primary-light text-sm mt-1">Dashboard e fechamento automático com exportação e PDF.</p>
                </div>
              </div>
            </div>
